...
Geometric operations include measures (area, length, ...), predicates (intersects, covers,...) and transformations (intersection, union, ...)
...
Spherical (or ellipsoidal) geometry computes distances, direction, areas etc. over the surface of the sphere (ellipsoid); lines connecting points are great circle arcs.
...
* run reverse dependency checks on all (300+) reverse dependencies, and theirs...
